...
class EventsControllerTest < ActionController::TestCase
  ...
  test "should update event" do
    patch :update, organization_id: @organization.name, id: @event, event: { hostname: @event.hostname, message: @event.message, organization_id: @event.organization_id, timestamp: @event.timestamp }
    assert_redirected_to organization_event_path(assigns(:organization), assigns(:event))
  end
